...
pets_train_orig = torchvision.datasets.OxfordIIITPet(root=pets_path_train,
                                                     split="trainval",
                                                     target_types="segmentation",
                                                     download=True)
pets_test_orig = torchvision.datasets.OxfordIIITPet(root=pets_path_test,
                                                    split="test",
                                                    target_types="segmentation",
                                                    download=True)
...
print(f'{train_pets_inputs.shape}, {train_pets_targets.shape}')
...
model_dsc.eval()
to_device(model_dsc)
print(model_dsc(to_device(train_pets_inputs)).shape)
...
print_test_dataset_masks(model_dsc, test_pets_inputs, test_pets_targets, epoch=0, save_path=None, show_plot=True)
...
train_loop(model_dsc, pets_train_loader, (test_pets_inputs, test_pets_targets), (1, 21), optimizer2, scheduler2,
           save_path2)