...
#
save_path = os.path.join(working_dir, "segnet_basic_training_progress_images")
train_loop(model, pets_train_loader, (test_pets_inputs, test_pets_targets), (1, 21), optimizer, scheduler, save_path)
...
train_loop(model_dsc, pets_train_loader, (test_pets_inputs, test_pets_targets), (1, 21), optimizer2, scheduler2, save_path2)