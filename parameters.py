...
tf_size = [6554, 504, 9799, 2655, 2831, 2135, 4400, 4890, 630, 840, 655, 524, 491, 469, 13454, 363, 392, 268, 10630,
           10258, 9094, 10304, 636, 961]

tf_size = tf_size + tf_size


def tf_path_splitted(value):
    folder_list = ['train000.tfrecords', 'train001.tfrecords', 'train002.tfrecords', 'train003.tfrecords',
                   'train004.tfrecords', 'train005.tfrecords',
                   'train006.tfrecords', 'train007.tfrecords', 'train008.tfrecords', 'train009.tfrecords',
                   'train010.tfrecords', 'train011.tfrecords',
                   'train012.tfrecords', 'train013.tfrecords', 'train014.tfrecords', 'train015.tfrecords',
                   'train016.tfrecords', 'train017.tfrecords',
                   'train018.tfrecords', 'train019.tfrecords', 'train020.tfrecords', 'train021.tfrecords',
                   'train022.tfrecords', 'train023.tfrecords']
    ...
    for jj in range(10):
        for ii in range(len(list_selected)):
            list_selected_ten[jj * len(list_selected) + ii] = tfFolderPath_splitted + str(jj).zfill(2) + \
                                                              list_selected_ten[jj * len(list_selected) + ii]
