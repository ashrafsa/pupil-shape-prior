...
class Unet4f32chSigmoid(nn.Module):
    ...
    def __init__(self):
        ...
        self.upsample3 = nn.ConvTranspose2d(in_channels=self.first * 8, out_channels=self.first * 4, kernel_size=2,
                                            stride=2)
        self.upsample2 = nn.ConvTranspose2d(in_channels=self.first * 4, out_channels=self.first * 2, kernel_size=2,
                                            stride=2)
        self.upsample1 = nn.ConvTranspose2d(in_channels=self.first * 2, out_channels=self.first, kernel_size=2,
                                            stride=2)
